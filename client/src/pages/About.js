      ...
      <div className="row">
        <div className="col-6">
          ...
          <div className="row">
            <div className="col-md-9">
              <p>
                We help restaurants connect with local non-profit organizations
                to donate their leftover food and reduce food waste.
              </p>
            </div>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-md-9">
              <p>
                {" "}
                The US is facing a food waste crisis. Up to 40% of all food goes
                to waste across the country, and restaurants alone throw away
                133 billion pounds of food each year.
              </p>
              <p>
              ...
              <p>
                ...
                security. <a href="/LogIn" className= "btn joinUs">Join Us Today</a>
